...
<div class="pageContent">
	<form method="post" action="${pageContext.request.contextPath}/sys/createemployee" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
		...
		<div class="pageFormContent" layoutH="98">
			...
			<p>
				...
				<input name="eNumber" type="text" size="30"  readonly="readonly"/>
			</p>
			<p>
				<label>英文名：</label>
